...
Future<void> copyNativeCodeAssetsIOS(
  ...
  if (assetTargetLocations.isNotEmpty) {
    ...
    final List<(File, String, Directory)> dylibs =
    ...
    for (final (File dylibFile, String newInstallName, Directory frameworkDir)
        in dylibs) {
      await setInstallNamesDylib(
          dylibFile, newInstallName, oldToNewInstallNames);
